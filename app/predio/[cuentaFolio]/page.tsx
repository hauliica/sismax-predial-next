  ...
  return (
    <section className="bg-gray-100 lg:p-4">
      <div className="mx-auto lg:container">
        <div>
          <h1 className="scroll-m-20 py-4 text-2xl font-semibold tracking-tight">Datos del Contribuyente y Predio</h1>
        </div>
        <div className="grid gap-4 bg-gray-100 md:grid-cols-2 lg:grid-cols-4 lg:p-6">
            ...
            <CardContent className="grid gap-1 lg:grid-cols-2 lg:gap-y-4">
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Nombre de Contribuyente</p>
                  <p className="text-sm font-medium leading-none">{predio.propietario}</p>
                </div>
              </div>
              {/* Domicilio */}
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">
                    {predio.dfcalle} #{predio.dfnum}, {predio.dfcolonia}, {predio.dfcd}
                  </p>
                </div>
              </div>
              {/* CURP */}
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">{predio.pcurp}</p>
                </div>
              </div>
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">{predio.prfc}</p>
                </div>
              </div>
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">{predio.dfcorreo ?? "Sin Correo"}</p>
                </div>
              </div>
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">{predio.dftel}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Resumen informativo sobre las características y detalles catastrales del predio.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                <HomeIcon className="mt-px h-5 w-5 text-amber-500" />
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Domicilio del Predio</p>
                  <p className="text-sm font-medium leading-none">
                    {predio.dpcalle} #{predio.dpnum}, {predio.dpcolonia}, {predio.dpcd}
                  </p>
                </div>
              </div>
              {/*  Clave Catastral*/}
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Clave Catastral</p>
                  <p className="text-sm font-medium leading-none">{predio.clavecatastral}</p>
                </div>
              </div>
              {/*  Valor Catastral*/}
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium leading-none">$ {predio.vcat}</p>
                </div>
              </div>
              ...
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Superificie de Terreno</p>
                  <p className="text-sm font-medium leading-none">{predio.terreno} m²</p>
                </div>
              </div>
              ...
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Superficie de Construccion</p>
                  <p className="text-sm font-medium leading-none">{predio.const} m²</p>
                </div>
              </div>
              {/*  Uso del Predio*/}
              <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">Uso del Predio</p>
                  <p className="text-sm font-medium leading-none">{predio.uso}</p>
                </div>
              </div>
            </CardContent>
          </Card>
